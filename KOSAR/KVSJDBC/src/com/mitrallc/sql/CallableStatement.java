...
public class CallableStatement implements java.sql.CallableStatement {
	...
	public boolean execute() throws SQLException {
		...
		if(KosarSoloDriver.webServer != null) {
			...
			KosarSoloDriver.last100updateQueries.add("Stored Procedure (Unknown) "+PreparedStatement.generateQueryString(this.input_StoredProcedure, this.param_list));
		}
		return retVal;
	}
	...
	public ResultSet executeQuery() throws SQLException {
		...
		if(KosarSoloDriver.webServer != null) {
			...
			KosarSoloDriver.KosarRTEventMonitor.newEvent(rt);
			KosarSoloDriver.KosarDMLUpdateEventMonitor.newEvent(rt);
			KosarSoloDriver.last100updateQueries.add("Stored Procedure (Query): "+PreparedStatement.generateQueryString(this.input_StoredProcedure, this.param_list));
		}
		return retVal;
	}
	...
	public int executeUpdate() throws SQLException {
		...
		if(KosarSoloDriver.webServer != null) {
			...
			KosarSoloDriver.KosarRTEventMonitor.newEvent(rt);
			KosarSoloDriver.KosarDMLUpdateEventMonitor.newEvent(rt);
			KosarSoloDriver.last100updateQueries.add("Stored Procedure (Update): "+PreparedStatement.generateQueryString(this.input_StoredProcedure, this.param_list) );
		}
		return retVal;
	}
