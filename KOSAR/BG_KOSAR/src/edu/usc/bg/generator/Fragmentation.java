...
public class Fragmentation {
	...
	public Fragmentation(int usercount, int numBGClients, int machineid, String probs, double ZipfianMean){
	...
	public static void main(String[] args){
		...
		for(int i=0; i<numBGClients; i++){
			Fragmentation createFrags = new Fragmentation(usercount, numBGClients,i,probs, ZipfianMean);
