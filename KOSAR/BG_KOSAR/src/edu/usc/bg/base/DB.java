...
public abstract class DB
{
	 ...
	 * This function is called in the benchmarking phase which is executed with the -t argument.
	 * 
	 * Retrieves the list of members whom are l hops away from both requesterID and profileID. If l=1 it computes the list of mutual friends between them.
	 * @param requesterID The unique identifier of the first member, this is the members invoking the action.
	 * @param profileID The unique identifier of the second member.
	 * @param l The distance of the members from both requesterID and profileID.
	 * @param fields Contains the attribute names required for each member. 
	 * This can be set to null to retrieve all the member information.
	 * @param result A Vector of HashMaps, where each HashMap is a set field/value pairs for one member.
	 * @param insertImage If set to true the thumbnail images for the members will be retrieved from the data store.
	 * @param testMode If set to true the thumbnail images of members will be written to the file system.
	 * @return Zero on success, a non-zero error code on error.  See this class's description for a discussion of error codes.
	 * 
	 * The code written for this function should retrieve the list of members which are l hops away from both requesterID and profileID.
	 * The information retrieved per member depends on the fields specified in the fields set. if fields is set to null
	 * all profile information for the members is retrieved and the result hashmap is populated.
	 * The member's unique id should be inserted with the "userid" key into the result hashmap. The lack of this attribute or the lack of 
	 * the attribute key in lower case causes BG to raise exceptions.
	 * In addition if the insertImage flag is set to true, the thumbnails for each friend's profile
	 * should be retrieved and inserted into the result hashmap using the "tpic" key.
	 * 
	 */
	public abstract int listCommonFriends(int requesterID, int profileID, int l, Set<String> fields, Vector<HashMap<String,ByteIterator>> result,  boolean insertImage, boolean testMode);
	 ...
	 * This function is called in the benchmarking phase which is executed with the -t argument.
	 * 
	 * Retrieves the list of friends whom are friends with profileID's friends.
	 * @param requesterID The unique identifier of the member invoking the action.
	 * @param profileID The unique identifier of member whose friends' list of friends is requested.
	 * @param fields Contains the attribute names required for each friend of friend. 
	 * This can be set to null to retrieve all member information.
	 * @param result A Vector of HashMaps, where each HashMap is a set field/value pairs for a friend of a friend.
	 * @param insertImage If set to true the thumbnail images for the members will be retrieved from the data store.
	 * @param testMode If set to true the thumbnail images of members will be written to the file system.
	 * @return Zero on success, a non-zero error code on error.  See this class's description for a discussion of error codes.
	 * 
	 * The code written for this function should retrieve the list of friends which are friends with profileID's friends.
	 * The information retrieved per member depends on the fields specified in the fields set. if fields is set to null
	 * all profile information for the members is retrieved and the result hashmap is populated.
	 * The member's unique id should be inserted with the "userid" key into the result hashmap. The lack of this attribute or the lack of 
	 * the attribute key in lower case causes BG to raise exceptions.
	 ...
	 * 
	 */
	public abstract int listFriendsOfFriends(int requesterID, int profileID, Set<String> fields, Vector<HashMap<String,ByteIterator>> result,  boolean insertImage, boolean testMode);
